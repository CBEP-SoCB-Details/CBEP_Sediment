...
```
We don't have sufficient detection to show a similar graphic for just the 2010s.
The Ramboll study treated non-detects as missing, thus biasing estimation of
sums, and failing to provide values to graph for many observations from recent
years, when non-detects were common.  We have chosen not to recalculate totals,
to minimize changes from the Ramboll report, but these graphics show why that
may be problematic.
```{r fig.width = 7, fig.height = 3.5}
sums_data %>%
