...
Note that metals are in $\mu g/g$ or ppm, organics are in $n g/g$ or ppb,
physical observations in percent.
...
per trilion.  There are no Squirts for Dioxins and Furans.  Instead, Ramboll
...
eighting each compound by its relative toxic effect, compared to some reference
compound (conventionally TCDD).

# Load SQuiRTs Data
We compare those totals to the SQuiRTs, when availalbe. Ramboll Environ's Access
